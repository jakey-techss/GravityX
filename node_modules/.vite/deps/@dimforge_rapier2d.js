...
import * as wasm from "C:/Users/Student/Desktop/GravityX/node_modules/@dimforge/rapier2d/rapier_wasm2d_bg.wasm";
//#region node_modules/@dimforge/rapier2d/rapier_wasm2d_bg.js
var wasm$1;
...
var cachedTextDecoder = new (typeof TextDecoder === "undefined" ? (0, module.require)("util").TextDecoder : TextDecoder)("utf-8", {
	ignoreBOM: true,
	fatal: true
});
...
function getInt32ArrayMemory0() {
	if (cachedInt32ArrayMemory0 === null || cachedInt32ArrayMemory0.byteLength === 0) cachedInt32ArrayMemory0 = new Int32Array(wasm$1.memory.buffer);
...
function getFloat32ArrayMemory0() {
	if (cachedFloat32ArrayMemory0 === null || cachedFloat32ArrayMemory0.byteLength === 0) cachedFloat32ArrayMemory0 = new Float32Array(wasm$1.memory.buffer);
...
function getUint32ArrayMemory0() {
	if (cachedUint32ArrayMemory0 === null || cachedUint32ArrayMemory0.byteLength === 0) cachedUint32ArrayMemory0 = new Uint32Array(wasm$1.memory.buffer);
...
var RawBroadPhaseFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawbroadphase_free(ptr >>> 0, 1));
var RawBroadPhase = class RawBroadPhase {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	castRayAndGetNormal(narrow_phase, bodies, colliders, rayOrig, rayDir, maxToi, solid, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
		try {
			...
			_assertClass(rayOrig, RawVector);
			_assertClass(rayDir, RawVector);
			const ret = wasm$1.rawbroadphase_castRayAndGetNormal(this.__wbg_ptr, narrow_phase.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, rayOrig.__wbg_ptr, rayDir.__wbg_ptr, maxToi, solid, filter_flags, isLikeNone(filter_groups) ? 4294967297 : filter_groups >>> 0, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, addBorrowedObject(filter_predicate));
	...
	*/
	projectPointAndGetFeature(narrow_phase, bodies, colliders, point, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
		try {
			...
			_assertClass(colliders, RawColliderSet);
			_assertClass(point, RawVector);
			const ret = wasm$1.rawbroadphase_projectPointAndGetFeature(this.__wbg_ptr, narrow_phase.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, point.__wbg_ptr, filter_flags, isLikeNone(filter_groups) ? 4294967297 : filter_groups >>> 0, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, addBorrowedObject(filter_predicate));
			return ret === 0 ? void 0 : RawPointColliderProjection.__wrap(ret);
		} finally {
			heap[stack_pointer++] = void 0;
		}
	...
	*/
	collidersWithAabbIntersectingAabb(narrow_phase, bodies, colliders, aabbCenter, aabbHalfExtents, callback) {
		try {
			...
			wasm$1.rawbroadphase_collidersWithAabbIntersectingAabb(this.__wbg_ptr, narrow_phase.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, aabbCenter.__wbg_ptr, aabbHalfExtents.__wbg_ptr, addBorrowedObject(callback));
		} finally {
			heap[stack_pointer++] = void 0;
		}
	}
};
var RawCCDSolverFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
var RawCharacterCollisionFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
var RawCharacterCollision = class {
	...
	*/
	handle() {
		return wasm$1.rawcharactercollision_handle(this.__wbg_ptr);
	}
	/**
	* @returns {RawVector}
	*/
	...
	*/
	toi() {
		return wasm$1.rawcharactercollision_toi(this.__wbg_ptr);
	}
	/**
	* @returns {RawVector}
	*/
...
var RawColliderSetFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawcolliderset_free(ptr >>> 0, 1));
var RawColliderSet = class RawColliderSet {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	coTranslationWrtParent(handle) {
		const ret = wasm$1.rawcolliderset_coTranslationWrtParent(this.__wbg_ptr, handle);
	...
	*/
	coRotationWrtParent(handle) {
		const ret = wasm$1.rawcolliderset_coRotationWrtParent(this.__wbg_ptr, handle);
	...
	*/
	coSetTranslation(handle, x, y) {
		wasm$1.rawcolliderset_coSetTranslation(this.__wbg_ptr, handle, x, y);
	}
	/**
	* @param {number} handle
	* @param {number} x
	...
	*/
	coSetTranslationWrtParent(handle, x, y) {
		wasm$1.rawcolliderset_coSetTranslationWrtParent(this.__wbg_ptr, handle, x, y);
	}
	/**
	...
	*/
	coSetRotation(handle, angle) {
		wasm$1.rawcolliderset_coSetRotation(this.__wbg_ptr, handle, angle);
	}
	/**
	* @param {number} handle
	* @param {number} angle
	*/
	coSetRotationWrtParent(handle, angle) {
		wasm$1.rawcolliderset_coSetRotationWrtParent(this.__wbg_ptr, handle, angle);
	}
	/**
	...
	*/
	coIsSensor(handle) {
		return wasm$1.rawcolliderset_coIsSensor(this.__wbg_ptr, handle) !== 0;
	}
	/**
	...
	*/
	coShapeType(handle) {
		return wasm$1.rawcolliderset_coShapeType(this.__wbg_ptr, handle);
	}
	/**
	* @param {number} handle
	* @returns {RawVector | undefined}
	...
	*/
	coSetVoxel(handle, ix, iy, filled) {
		wasm$1.rawcolliderset_coSetVoxel(this.__wbg_ptr, handle, ix, iy, filled);
	}
	/**
	...
	*/
	coPropagateVoxelChange(handle1, handle2, ix, iy, shift_x, shift_y) {
		wasm$1.rawcolliderset_coPropagateVoxelChange(this.__wbg_ptr, handle1, handle2, ix, iy, shift_x, shift_y);
	}
	/**
	* @param {number} handle1
	* @param {number} handle2
	...
	*/
	coCombineVoxelStates(handle1, handle2, shift_x, shift_y) {
		wasm$1.rawcolliderset_coCombineVoxelStates(this.__wbg_ptr, handle1, handle2, shift_x, shift_y);
	}
	/**
	...
	*/
	coIsEnabled(handle) {
		return wasm$1.rawcolliderset_coIsEnabled(this.__wbg_ptr, handle) !== 0;
	}
	/**
	* @param {number} handle
	...
	*/
	coContactSkin(handle) {
		return wasm$1.rawcolliderset_coContactSkin(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	coFriction(handle) {
		return wasm$1.rawcolliderset_coFriction(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	coRestitution(handle) {
		return wasm$1.rawcolliderset_coRestitution(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	coDensity(handle) {
		return wasm$1.rawcolliderset_coDensity(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	coMass(handle) {
		return wasm$1.rawcolliderset_coMass(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	coVolume(handle) {
		return wasm$1.rawcolliderset_coVolume(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	coCollisionGroups(handle) {
		return wasm$1.rawcolliderset_coCollisionGroups(this.__wbg_ptr, handle) >>> 0;
	}
	/**
	...
	*/
	coSolverGroups(handle) {
		return wasm$1.rawcolliderset_coSolverGroups(this.__wbg_ptr, handle) >>> 0;
	}
	/**
	...
	*/
	coActiveHooks(handle) {
		return wasm$1.rawcolliderset_coActiveHooks(this.__wbg_ptr, handle) >>> 0;
	}
	/**
	...
	*/
	coActiveCollisionTypes(handle) {
		return wasm$1.rawcolliderset_coActiveCollisionTypes(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	coActiveEvents(handle) {
		return wasm$1.rawcolliderset_coActiveEvents(this.__wbg_ptr, handle) >>> 0;
	}
	/**
	...
	*/
	coContactForceEventThreshold(handle) {
		return wasm$1.rawcolliderset_coContactForceEventThreshold(this.__wbg_ptr, handle);
	}
	/**
	* @param {number} handle
	* @param {RawVector} point
	...
	*/
	coContainsPoint(handle, point) {
		_assertClass(point, RawVector);
		return wasm$1.rawcolliderset_coContainsPoint(this.__wbg_ptr, handle, point.__wbg_ptr) !== 0;
	}
	/**
	* @param {number} handle
	...
	*/
	coIntersectsShape(handle, shape2, shapePos2, shapeRot2) {
		...
		return wasm$1.rawcolliderset_coIntersectsShape(this.__wbg_ptr, handle, shape2.__wbg_ptr, shapePos2.__wbg_ptr, shapeRot2.__wbg_ptr) !== 0;
	}
	/**
	* @param {number} handle
	* @param {RawShape} shape2
	...
	*/
	coIntersectsRay(handle, rayOrig, rayDir, maxToi) {
		_assertClass(rayOrig, RawVector);
		_assertClass(rayDir, RawVector);
		return wasm$1.rawcolliderset_coIntersectsRay(this.__wbg_ptr, handle, rayOrig.__wbg_ptr, rayDir.__wbg_ptr, maxToi) !== 0;
	}
	/**
	* @param {number} handle
	* @param {RawVector} rayOrig
	...
	*/
	coCastRay(handle, rayOrig, rayDir, maxToi, solid) {
		_assertClass(rayOrig, RawVector);
		_assertClass(rayDir, RawVector);
		return wasm$1.rawcolliderset_coCastRay(this.__wbg_ptr, handle, rayOrig.__wbg_ptr, rayDir.__wbg_ptr, maxToi, solid);
	}
	/**
	* @param {number} handle
	* @param {RawVector} rayOrig
	...
	*/
	coFrictionCombineRule(handle) {
		return wasm$1.rawcolliderset_coFrictionCombineRule(this.__wbg_ptr, handle) >>> 0;
	}
	/**
	* @param {number} handle
	* @param {number} rule
	...
	*/
	coRestitutionCombineRule(handle) {
		return wasm$1.rawcolliderset_coRestitutionCombineRule(this.__wbg_ptr, handle) >>> 0;
	}
	/**
	* @param {number} handle
	* @param {number} rule
	...
	*/
	coSetMassProperties(handle, mass, centerOfMass, principalAngularInertia) {
		...
		wasm$1.rawcolliderset_coSetMassProperties(this.__wbg_ptr, handle, mass, centerOfMass.__wbg_ptr, principalAngularInertia);
	}
	constructor() {
	...
	*/
	len() {
		return wasm$1.rawcolliderset_len(this.__wbg_ptr) >>> 0;
	}
	/**
	* @param {number} handle
	* @returns {boolean}
	*/
	contains(handle) {
		return wasm$1.rawcolliderset_contains(this.__wbg_ptr, handle) !== 0;
	}
	/**
	* @param {boolean} enabled
	* @param {RawShape} shape
	...
	*/
	createCollider(enabled, shape, translation, rotation, massPropsMode, mass, centerOfMass, principalAngularInertia, density, friction, restitution, frictionCombineRule, restitutionCombineRule, isSensor, collisionGroups, solverGroups, activeCollisionTypes, activeHooks, activeEvents, contactForceEventThreshold, contactSkin, hasParent, parent, bodies) {
		try {
			...
			_assertClass(centerOfMass, RawVector);
			_assertClass(bodies, RawRigidBodySet);
			wasm$1.rawcolliderset_createCollider(retptr, this.__wbg_ptr, enabled, shape.__wbg_ptr, translation.__wbg_ptr, rotation.__wbg_ptr, massPropsMode, mass, centerOfMass.__wbg_ptr, principalAngularInertia, density, friction, restitution, frictionCombineRule, restitutionCombineRule, isSensor, collisionGroups, solverGroups, activeCollisionTypes, activeHooks, activeEvents, contactForceEventThreshold, contactSkin, hasParent, parent, bodies.__wbg_ptr);
			var r0 = getDataViewMemory0().getInt32(retptr + 0, true);
			var r2 = getDataViewMemory0().getFloat64(retptr + 8, true);
			return r0 === 0 ? void 0 : r2;
		} finally {
...
var RawColliderShapeCastHitFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawcollidershapecasthit_free(ptr >>> 0, 1));
var RawColliderShapeCastHit = class RawColliderShapeCastHit {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	colliderHandle() {
		return wasm$1.rawcollidershapecasthit_colliderHandle(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	time_of_impact() {
		return wasm$1.rawcollidershapecasthit_time_of_impact(this.__wbg_ptr);
	}
	/**
	* @returns {RawVector}
	*/
	...
	*/
	normal1() {
		const ret = wasm$1.rawcollidershapecasthit_normal1(this.__wbg_ptr);
		return RawVector.__wrap(ret);
	}
	/**
	* @returns {RawVector}
	*/
	normal2() {
		const ret = wasm$1.rawcollidershapecasthit_normal2(this.__wbg_ptr);
		return RawVector.__wrap(ret);
	}
};
typeof FinalizationRegistry === "undefined" || new FinalizationRegistry((ptr) => wasm$1.__wbg_rawcontactforceevent_free(ptr >>> 0, 1));
var RawContactManifoldFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawcontactmanifold_free(ptr >>> 0, 1));
var RawContactManifold = class RawContactManifold {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	subshape1() {
		return wasm$1.rawcontactmanifold_subshape1(this.__wbg_ptr) >>> 0;
	}
	/**
	* @returns {number}
	*/
	subshape2() {
		return wasm$1.rawcontactmanifold_subshape2(this.__wbg_ptr) >>> 0;
	}
	/**
	* @returns {number}
	*/
	num_contacts() {
		return wasm$1.rawcontactmanifold_num_contacts(this.__wbg_ptr) >>> 0;
	}
	/**
	* @param {number} i
	* @returns {RawVector | undefined}
	...
	*/
	contact_dist(i) {
		return wasm$1.rawcontactmanifold_contact_dist(this.__wbg_ptr, i);
	}
	/**
	* @param {number} i
	* @returns {number}
	*/
	contact_fid1(i) {
		return wasm$1.rawcontactmanifold_contact_fid1(this.__wbg_ptr, i) >>> 0;
	}
	/**
	* @param {number} i
	* @returns {number}
	*/
	contact_fid2(i) {
		return wasm$1.rawcontactmanifold_contact_fid2(this.__wbg_ptr, i) >>> 0;
	}
	/**
	* @param {number} i
	* @returns {number}
	*/
	contact_impulse(i) {
		return wasm$1.rawcontactmanifold_contact_impulse(this.__wbg_ptr, i);
	}
	/**
	* @param {number} i
	* @returns {number}
	*/
	contact_tangent_impulse(i) {
		return wasm$1.rawcontactmanifold_contact_tangent_impulse(this.__wbg_ptr, i);
	}
	/**
	* @returns {number}
	*/
	num_solver_contacts() {
		return wasm$1.rawcontactmanifold_num_solver_contacts(this.__wbg_ptr) >>> 0;
	}
	/**
	* @param {number} i
	* @returns {RawVector | undefined}
	...
	*/
	solver_contact_dist(i) {
		return wasm$1.rawcontactmanifold_solver_contact_dist(this.__wbg_ptr, i);
	}
	/**
	* @param {number} i
	* @returns {number}
	*/
	solver_contact_friction(i) {
		return wasm$1.rawcontactmanifold_solver_contact_friction(this.__wbg_ptr, i);
	}
	/**
	* @param {number} i
	* @returns {number}
	*/
	solver_contact_restitution(i) {
		return wasm$1.rawcontactmanifold_solver_contact_restitution(this.__wbg_ptr, i);
	}
	/**
	* @param {number} i
	* @returns {RawVector}
...
var RawContactPairFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawcontactpair_free(ptr >>> 0, 1));
var RawContactPair = class RawContactPair {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	collider1() {
		return wasm$1.rawcontactpair_collider1(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	collider2() {
		return wasm$1.rawcontactpair_collider2(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	numContactManifolds() {
		return wasm$1.rawcontactpair_numContactManifolds(this.__wbg_ptr) >>> 0;
	}
	/**
	* @param {number} i
...
var RawDebugRenderPipelineFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
var RawDebugRenderPipeline = class {
	...
	*/
	vertices() {
		return takeObject(wasm$1.rawdebugrenderpipeline_vertices(this.__wbg_ptr));
	}
	/**
	* @returns {Float32Array}
	*/
	colors() {
		return takeObject(wasm$1.rawdebugrenderpipeline_colors(this.__wbg_ptr));
	}
	/**
	* @param {RawRigidBodySet} bodies
	* @param {RawColliderSet} colliders
...
var RawDeserializedWorldFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawdeserializedworld_free(ptr >>> 0, 1));
var RawDeserializedWorld = class RawDeserializedWorld {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
...
var RawEventQueueFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
var RawGenericJointFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawgenericjoint_free(ptr >>> 0, 1));
var RawGenericJoint = class RawGenericJoint {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	static revolute(anchor1, anchor2) {
		_assertClass(anchor1, RawVector);
		_assertClass(anchor2, RawVector);
		const ret = wasm$1.rawgenericjoint_revolute(anchor1.__wbg_ptr, anchor2.__wbg_ptr);
		return ret === 0 ? void 0 : RawGenericJoint.__wrap(ret);
	}
};
var RawImpulseJointSetFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawimpulsejointset_free(ptr >>> 0, 1));
var RawImpulseJointSet = class RawImpulseJointSet {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	jointType(handle) {
		return wasm$1.rawimpulsejointset_jointType(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	jointBodyHandle1(handle) {
		return wasm$1.rawimpulsejointset_jointBodyHandle1(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	jointBodyHandle2(handle) {
		return wasm$1.rawimpulsejointset_jointBodyHandle2(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	jointContactsEnabled(handle) {
		return wasm$1.rawimpulsejointset_jointContactsEnabled(this.__wbg_ptr, handle) !== 0;
	}
	/**
	...
	*/
	jointLimitsEnabled(handle, axis) {
		return wasm$1.rawimpulsejointset_jointLimitsEnabled(this.__wbg_ptr, handle, axis) !== 0;
	}
	/**
	...
	*/
	jointLimitsMin(handle, axis) {
		return wasm$1.rawimpulsejointset_jointLimitsMin(this.__wbg_ptr, handle, axis);
	}
	/**
	...
	*/
	jointLimitsMax(handle, axis) {
		return wasm$1.rawimpulsejointset_jointLimitsMax(this.__wbg_ptr, handle, axis);
	}
	/**
	...
	*/
	createJoint(params, parent1, parent2, wake_up) {
		...
		return wasm$1.rawimpulsejointset_createJoint(this.__wbg_ptr, params.__wbg_ptr, parent1, parent2, wake_up);
	}
	/**
	* @param {number} handle
	* @param {boolean} wakeUp
	...
	*/
	len() {
		return wasm$1.rawimpulsejointset_len(this.__wbg_ptr) >>> 0;
	}
	/**
	* @param {number} handle
	* @returns {boolean}
	*/
	contains(handle) {
		return wasm$1.rawimpulsejointset_contains(this.__wbg_ptr, handle) !== 0;
	}
	/**
...
var RawIntegrationParametersFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawintegrationparameters_free(ptr >>> 0, 1));
var RawIntegrationParameters = class RawIntegrationParameters {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	get dt() {
		return wasm$1.rawintegrationparameters_dt(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	get contact_erp() {
		return wasm$1.rawintegrationparameters_contact_erp(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	get normalizedAllowedLinearError() {
		return wasm$1.rawcontactforceevent_total_force_magnitude(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	...
	*/
	get numSolverIterations() {
		return wasm$1.rawintegrationparameters_numSolverIterations(this.__wbg_ptr) >>> 0;
	}
	/**
	* @returns {number}
	*/
	get numInternalPgsIterations() {
		return wasm$1.rawintegrationparameters_numInternalPgsIterations(this.__wbg_ptr) >>> 0;
	}
	/**
	* @returns {number}
	*/
	get minIslandSize() {
		return wasm$1.rawintegrationparameters_minIslandSize(this.__wbg_ptr) >>> 0;
	}
	/**
	* @returns {number}
	*/
	get maxCcdSubsteps() {
		return wasm$1.rawintegrationparameters_maxCcdSubsteps(this.__wbg_ptr) >>> 0;
	}
	/**
	* @returns {number}
	*/
	get lengthUnit() {
		return wasm$1.rawintegrationparameters_lengthUnit(this.__wbg_ptr);
	}
	/**
	* @param {number} value
	*/
	...
	*/
	set numInternalPgsIterations(value) {
		wasm$1.rawintegrationparameters_set_numInternalPgsIterations(this.__wbg_ptr, value);
	}
	/**
	* @param {number} value
	*/
...
var RawIslandManagerFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawislandmanager_free(ptr >>> 0, 1));
var RawIslandManager = class RawIslandManager {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
...
var RawKinematicCharacterControllerFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
var RawKinematicCharacterController = class {
	...
	*/
	normalNudgeFactor() {
		return wasm$1.rawkinematiccharactercontroller_normalNudgeFactor(this.__wbg_ptr);
	}
	/**
	* @param {number} value
	*/
	...
	*/
	offset() {
		return wasm$1.rawkinematiccharactercontroller_offset(this.__wbg_ptr);
	}
	/**
	* @param {number} value
	*/
	...
	*/
	slideEnabled() {
		return wasm$1.rawkinematiccharactercontroller_slideEnabled(this.__wbg_ptr) !== 0;
	}
	/**
	* @param {boolean} enabled
	*/
	...
	*/
	autostepEnabled() {
		return wasm$1.rawkinematiccharactercontroller_autostepEnabled(this.__wbg_ptr) !== 0;
	}
	/**
	...
	*/
	maxSlopeClimbAngle() {
		return wasm$1.rawkinematiccharactercontroller_maxSlopeClimbAngle(this.__wbg_ptr);
	}
	/**
	* @param {number} angle
	*/
	...
	*/
	minSlopeSlideAngle() {
		return wasm$1.rawkinematiccharactercontroller_minSlopeSlideAngle(this.__wbg_ptr);
	}
	/**
	* @param {number} angle
	*/
	...
	*/
	snapToGroundEnabled() {
		return wasm$1.rawkinematiccharactercontroller_snapToGroundEnabled(this.__wbg_ptr) !== 0;
	}
	/**
	* @param {number} dt
	...
	*/
	computedGrounded() {
		return wasm$1.rawkinematiccharactercontroller_computedGrounded(this.__wbg_ptr) !== 0;
	}
	/**
	* @returns {number}
	*/
	numComputedCollisions() {
		return wasm$1.rawkinematiccharactercontroller_numComputedCollisions(this.__wbg_ptr) >>> 0;
	}
	/**
	* @param {number} i
	...
	*/
	computedCollision(i, collision) {
		...
		return wasm$1.rawkinematiccharactercontroller_computedCollision(this.__wbg_ptr, i, collision.__wbg_ptr) !== 0;
	}
};
var RawMultibodyJointSetFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawmultibodyjointset_free(ptr >>> 0, 1));
var RawMultibodyJointSet = class RawMultibodyJointSet {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	jointType(handle) {
		return wasm$1.rawmultibodyjointset_jointType(this.__wbg_ptr, handle);
	}
	/**
	* The angular part of the joint’s local frame relative to the first rigid-body it is attached to.
	* @param {number} handle
	...
	*/
	jointContactsEnabled(handle) {
		return wasm$1.rawmultibodyjointset_jointContactsEnabled(this.__wbg_ptr, handle) !== 0;
	}
	/**
	* Sets whether contacts are enabled between the rigid-bodies attached by this joint.
	* @param {number} handle
	...
	*/
	jointLimitsEnabled(handle, axis) {
		return wasm$1.rawmultibodyjointset_jointLimitsEnabled(this.__wbg_ptr, handle, axis) !== 0;
	}
	/**
	* Return the lower limit along the given joint axis.
	* @param {number} handle
	...
	*/
	jointLimitsMin(handle, axis) {
		return wasm$1.rawmultibodyjointset_jointLimitsMin(this.__wbg_ptr, handle, axis);
	}
	/**
	* If this is a prismatic joint, returns its upper limit.
	* @param {number} handle
	...
	*/
	jointLimitsMax(handle, axis) {
		return wasm$1.rawmultibodyjointset_jointLimitsMax(this.__wbg_ptr, handle, axis);
	}
	constructor() {
	...
	*/
	createJoint(params, parent1, parent2, wakeUp) {
		_assertClass(params, RawGenericJoint);
		return wasm$1.rawmultibodyjointset_createJoint(this.__wbg_ptr, params.__wbg_ptr, parent1, parent2, wakeUp);
	}
	/**
	* @param {number} handle
	* @param {boolean} wakeUp
	...
	*/
	contains(handle) {
		return wasm$1.rawmultibodyjointset_contains(this.__wbg_ptr, handle) !== 0;
	}
	/**
	* Applies the given JavaScript function to the integer handle of each joint managed by this physics world.
	*
...
var RawNarrowPhaseFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawnarrowphase_free(ptr >>> 0, 1));
var RawNarrowPhase = class RawNarrowPhase {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	intersection_pair(handle1, handle2) {
		return wasm$1.rawnarrowphase_intersection_pair(this.__wbg_ptr, handle1, handle2) !== 0;
	}
};
var RawPhysicsPipelineFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
var RawPhysicsPipeline = class {
	...
	*/
	set_profiler_enabled(enabled) {
		wasm$1.rawphysicspipeline_set_profiler_enabled(this.__wbg_ptr, enabled);
	}
	/**
	* @returns {boolean}
	*/
	is_profiler_enabled() {
		return wasm$1.rawphysicspipeline_is_profiler_enabled(this.__wbg_ptr) !== 0;
	}
	/**
	* @returns {number}
	*/
	timing_step() {
		return wasm$1.rawphysicspipeline_timing_step(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_collision_detection() {
		return wasm$1.rawphysicspipeline_timing_collision_detection(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_broad_phase() {
		return wasm$1.rawphysicspipeline_timing_broad_phase(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_narrow_phase() {
		return wasm$1.rawphysicspipeline_timing_narrow_phase(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_solver() {
		return wasm$1.rawphysicspipeline_timing_solver(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_velocity_assembly() {
		return wasm$1.rawphysicspipeline_timing_velocity_assembly(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_velocity_resolution() {
		return wasm$1.rawphysicspipeline_timing_velocity_resolution(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_velocity_update() {
		return wasm$1.rawphysicspipeline_timing_velocity_update(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_velocity_writeback() {
		return wasm$1.rawphysicspipeline_timing_velocity_writeback(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_ccd() {
		return wasm$1.rawphysicspipeline_timing_ccd(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_ccd_toi_computation() {
		return wasm$1.rawphysicspipeline_timing_ccd_toi_computation(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_ccd_broad_phase() {
		return wasm$1.rawphysicspipeline_timing_ccd_broad_phase(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_ccd_narrow_phase() {
		return wasm$1.rawphysicspipeline_timing_ccd_narrow_phase(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_ccd_solver() {
		return wasm$1.rawphysicspipeline_timing_ccd_solver(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_island_construction() {
		return wasm$1.rawphysicspipeline_timing_island_construction(this.__wbg_ptr);
	}
	/**
	* @returns {number}
	*/
	timing_user_changes() {
		return wasm$1.rawphysicspipeline_timing_user_changes(this.__wbg_ptr);
	}
	/**
...
var RawPidControllerFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
var RawPidController = class {
	...
	*/
	apply_angular_correction(dt, bodies, rb_handle, target_rotation, target_angvel) {
		_assertClass(bodies, RawRigidBodySet);
		wasm$1.rawpidcontroller_apply_angular_correction(this.__wbg_ptr, dt, bodies.__wbg_ptr, rb_handle, target_rotation, target_angvel);
	}
	/**
	* @param {number} dt
	* @param {RawRigidBodySet} bodies
	...
	*/
	angular_correction(dt, bodies, rb_handle, target_rotation, target_angvel) {
		_assertClass(bodies, RawRigidBodySet);
		return wasm$1.rawpidcontroller_angular_correction(this.__wbg_ptr, dt, bodies.__wbg_ptr, rb_handle, target_rotation, target_angvel);
	}
};
var RawPointColliderProjectionFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawpointcolliderprojection_free(ptr >>> 0, 1));
var RawPointColliderProjection = class RawPointColliderProjection {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	colliderHandle() {
		return wasm$1.rawpointcolliderprojection_colliderHandle(this.__wbg_ptr);
	}
	/**
	* @returns {RawVector}
	*/
	...
	*/
	isInside() {
		return wasm$1.rawpointcolliderprojection_isInside(this.__wbg_ptr) !== 0;
	}
	/**
	* @returns {RawFeatureType}
	*/
	featureType() {
		return wasm$1.rawpointcolliderprojection_featureType(this.__wbg_ptr);
	}
	/**
	* @returns {number | undefined}
	*/
...
var RawPointProjectionFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawpointprojection_free(ptr >>> 0, 1));
var RawPointProjection = class RawPointProjection {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	isInside() {
		return wasm$1.rawpointprojection_isInside(this.__wbg_ptr) !== 0;
	}
};
var RawRayColliderHitFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawraycolliderhit_free(ptr >>> 0, 1));
var RawRayColliderHit = class RawRayColliderHit {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
...
var RawRayColliderIntersectionFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawraycolliderintersection_free(ptr >>> 0, 1));
var RawRayColliderIntersection = class RawRayColliderIntersection {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
...
var RawRayIntersectionFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawrayintersection_free(ptr >>> 0, 1));
var RawRayIntersection = class RawRayIntersection {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
...
var RawRigidBodySetFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawrigidbodyset_free(ptr >>> 0, 1));
var RawRigidBodySet = class RawRigidBodySet {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	rbIsSleeping(handle) {
		return wasm$1.rawrigidbodyset_rbIsSleeping(this.__wbg_ptr, handle) !== 0;
	}
	/**
	...
	*/
	rbIsMoving(handle) {
		return wasm$1.rawrigidbodyset_rbIsMoving(this.__wbg_ptr, handle) !== 0;
	}
	/**
	...
	*/
	rbSetTranslation(handle, x, y, wakeUp) {
		wasm$1.rawrigidbodyset_rbSetTranslation(this.__wbg_ptr, handle, x, y, wakeUp);
	}
	/**
	...
	*/
	rbSetRotation(handle, angle, wakeUp) {
		wasm$1.rawrigidbodyset_rbSetRotation(this.__wbg_ptr, handle, angle, wakeUp);
	}
	/**
	...
	*/
	rbSetAngvel(handle, angvel, wakeUp) {
		wasm$1.rawrigidbodyset_rbSetAngvel(this.__wbg_ptr, handle, angvel, wakeUp);
	}
	/**
	...
	*/
	rbSetNextKinematicTranslation(handle, x, y) {
		wasm$1.rawrigidbodyset_rbSetNextKinematicTranslation(this.__wbg_ptr, handle, x, y);
	}
	/**
	...
	*/
	rbSetNextKinematicRotation(handle, angle) {
		wasm$1.rawrigidbodyset_rbSetNextKinematicRotation(this.__wbg_ptr, handle, angle);
	}
	/**
	* @param {number} handle
	* @param {RawColliderSet} colliders
	...
	*/
	rbSetAdditionalMassProperties(handle, mass, centerOfMass, principalAngularInertia, wake_up) {
		_assertClass(centerOfMass, RawVector);
		wasm$1.rawrigidbodyset_rbSetAdditionalMassProperties(this.__wbg_ptr, handle, mass, centerOfMass.__wbg_ptr, principalAngularInertia, wake_up);
	}
	/**
	...
	*/
	rbAngvel(handle) {
		return wasm$1.rawrigidbodyset_rbAngvel(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbSetEnabledTranslations(handle, allow_x, allow_y, wake_up) {
		wasm$1.rawrigidbodyset_rbSetEnabledTranslations(this.__wbg_ptr, handle, allow_x, allow_y, wake_up);
	}
	/**
	* @param {number} handle
	* @param {boolean} locked
	...
	*/
	rbDominanceGroup(handle) {
		return wasm$1.rawrigidbodyset_rbDominanceGroup(this.__wbg_ptr, handle);
	}
	/**
	* @param {number} handle
	* @param {number} group
	...
	*/
	rbMass(handle) {
		return wasm$1.rawrigidbodyset_rbMass(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbInvMass(handle) {
		return wasm$1.rawrigidbodyset_rbInvMass(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbInvPrincipalInertia(handle) {
		return wasm$1.rawrigidbodyset_rbInvPrincipalInertia(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbPrincipalInertia(handle) {
		return wasm$1.rawrigidbodyset_rbPrincipalInertia(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbEffectiveWorldInvInertia(handle) {
		return wasm$1.rawrigidbodyset_rbEffectiveWorldInvInertia(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbEffectiveAngularInertia(handle) {
		return wasm$1.rawrigidbodyset_rbEffectiveAngularInertia(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbIsCcdEnabled(handle) {
		return wasm$1.rawrigidbodyset_rbIsCcdEnabled(this.__wbg_ptr, handle) !== 0;
	}
	/**
	* @param {number} handle
	* @returns {number}
	*/
	rbSoftCcdPrediction(handle) {
		return wasm$1.rawrigidbodyset_rbSoftCcdPrediction(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbNumColliders(handle) {
		return wasm$1.rawrigidbodyset_rbNumColliders(this.__wbg_ptr, handle) >>> 0;
	}
	/**
	...
	*/
	rbCollider(handle, at) {
		return wasm$1.rawrigidbodyset_rbCollider(this.__wbg_ptr, handle, at);
	}
	/**
	...
	*/
	rbBodyType(handle) {
		return wasm$1.rawrigidbodyset_rbBodyType(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbIsFixed(handle) {
		return wasm$1.rawrigidbodyset_rbIsFixed(this.__wbg_ptr, handle) !== 0;
	}
	/**
	...
	*/
	rbIsKinematic(handle) {
		return wasm$1.rawrigidbodyset_rbIsKinematic(this.__wbg_ptr, handle) !== 0;
	}
	/**
	...
	*/
	rbIsDynamic(handle) {
		return wasm$1.rawrigidbodyset_rbIsDynamic(this.__wbg_ptr, handle) !== 0;
	}
	/**
	...
	*/
	rbLinearDamping(handle) {
		return wasm$1.rawrigidbodyset_rbLinearDamping(this.__wbg_ptr, handle);
	}
	/**
	...
	*/
	rbAngularDamping(handle) {
		return wasm$1.rawrigidbodyset_rbAngularDamping(this.__wbg_ptr, handle);
	}
	/**
	* @param {number} handle
	* @param {number} factor
	...
	*/
	rbIsEnabled(handle) {
		return wasm$1.rawrigidbodyset_rbIsEnabled(this.__wbg_ptr, handle) !== 0;
	}
	/**
	* @param {number} handle
	* @returns {number}
	*/
	rbGravityScale(handle) {
		return wasm$1.rawrigidbodyset_rbGravityScale(this.__wbg_ptr, handle);
	}
	/**
	* @param {number} handle
	* @param {number} factor
	...
	*/
	rbAddTorque(handle, torque, wakeUp) {
		wasm$1.rawrigidbodyset_rbAddTorque(this.__wbg_ptr, handle, torque, wakeUp);
	}
	/**
	...
	*/
	rbApplyTorqueImpulse(handle, torque_impulse, wakeUp) {
		wasm$1.rawrigidbodyset_rbApplyTorqueImpulse(this.__wbg_ptr, handle, torque_impulse, wakeUp);
	}
	/**
	...
	*/
	rbAdditionalSolverIterations(handle) {
		return wasm$1.rawrigidbodyset_rbAdditionalSolverIterations(this.__wbg_ptr, handle) >>> 0;
	}
	/**
	* @param {number} handle
	* @param {number} iters
	...
	*/
	rbUserData(handle) {
		return wasm$1.rawrigidbodyset_rbUserData(this.__wbg_ptr, handle) >>> 0;
	}
	/**
	...
	*/
	rbUserTorque(handle) {
		return wasm$1.rawrigidbodyset_rbUserTorque(this.__wbg_ptr, handle);
	}
	constructor() {
	...
	*/
	createRigidBody(enabled, translation, rotation, gravityScale, mass, massOnly, centerOfMass, linvel, angvel, principalAngularInertia, translationEnabledX, translationEnabledY, rotationsEnabled, linearDamping, angularDamping, rb_type, canSleep, sleeping, softCcdPrediciton, ccdEnabled, dominanceGroup, additional_solver_iterations) {
		...
		_assertClass(centerOfMass, RawVector);
		_assertClass(linvel, RawVector);
		return wasm$1.rawrigidbodyset_createRigidBody(this.__wbg_ptr, enabled, translation.__wbg_ptr, rotation.__wbg_ptr, gravityScale, mass, massOnly, centerOfMass.__wbg_ptr, linvel.__wbg_ptr, angvel, principalAngularInertia, translationEnabledX, translationEnabledY, rotationsEnabled, linearDamping, angularDamping, rb_type, canSleep, sleeping, softCcdPrediciton, ccdEnabled, dominanceGroup, additional_solver_iterations);
	}
	/**
	* @param {number} handle
	* @param {RawIslandManager} islands
	...
	*/
	len() {
		return wasm$1.rawrigidbodyset_len(this.__wbg_ptr) >>> 0;
	}
	/**
	...
	*/
	contains(handle) {
		return wasm$1.rawrigidbodyset_contains(this.__wbg_ptr, handle) !== 0;
	}
	/**
...
var RawRotationFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
*/
var RawRotation = class RawRotation {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	static fromAngle(angle) {
		const ret = wasm$1.rawrotation_fromAngle(angle);
		return RawRotation.__wrap(ret);
	}
	/**
	...
	*/
	get angle() {
		return wasm$1.rawrotation_angle(this.__wbg_ptr);
	}
};
var RawSerializationPipelineFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
var RawSerializationPipeline = class {
	...
	*/
	serializeAll(gravity, integrationParameters, islands, broadPhase, narrowPhase, bodies, colliders, impulse_joints, multibody_joints) {
		...
		_assertClass(impulse_joints, RawImpulseJointSet);
		_assertClass(multibody_joints, RawMultibodyJointSet);
		return takeObject(wasm$1.rawserializationpipeline_serializeAll(this.__wbg_ptr, gravity.__wbg_ptr, integrationParameters.__wbg_ptr, islands.__wbg_ptr, broadPhase.__wbg_ptr, narrowPhase.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, impulse_joints.__wbg_ptr, multibody_joints.__wbg_ptr));
	}
	/**
...
var RawShapeFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawshape_free(ptr >>> 0, 1));
var RawShape = class RawShape {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	static cuboid(hx, hy) {
		const ret = wasm$1.rawshape_cuboid(hx, hy);
	...
	*/
	static roundCuboid(hx, hy, borderRadius) {
		const ret = wasm$1.rawshape_roundCuboid(hx, hy, borderRadius);
		return RawShape.__wrap(ret);
	}
	/**
	* @param {number} radius
	...
	*/
	static heightfield(heights, scale) {
		...
		const ret = wasm$1.rawshape_heightfield(ptr0, len0, scale.__wbg_ptr);
		return RawShape.__wrap(ret);
	}
	/**
	* @param {RawVector} p1
	...
	*/
	static convexPolyline(vertices) {
		const ptr0 = passArrayF32ToWasm0(vertices, wasm$1.__wbindgen_export_2);
		const len0 = WASM_VECTOR_LEN;
		const ret = wasm$1.rawshape_convexPolyline(ptr0, len0);
		return ret === 0 ? void 0 : RawShape.__wrap(ret);
	}
	/**
	* @param {Float32Array} vertices
	...
	*/
	static roundConvexPolyline(vertices, borderRadius) {
		const ptr0 = passArrayF32ToWasm0(vertices, wasm$1.__wbindgen_export_2);
		const len0 = WASM_VECTOR_LEN;
		const ret = wasm$1.rawshape_roundConvexPolyline(ptr0, len0, borderRadius);
		return ret === 0 ? void 0 : RawShape.__wrap(ret);
	}
	/**
	...
	*/
	intersectsShape(shapePos1, shapeRot1, shape2, shapePos2, shapeRot2) {
		...
		_assertClass(shapePos2, RawVector);
		_assertClass(shapeRot2, RawRotation);
		return wasm$1.rawshape_intersectsShape(this.__wbg_ptr, shapePos1.__wbg_ptr, shapeRot1.__wbg_ptr, shape2.__wbg_ptr, shapePos2.__wbg_ptr, shapeRot2.__wbg_ptr) !== 0;
	}
	/**
	* @param {RawVector} shapePos1
	* @param {RawRotation} shapeRot1
	...
	*/
	containsPoint(shapePos, shapeRot, point) {
		...
		_assertClass(shapeRot, RawRotation);
		_assertClass(point, RawVector);
		return wasm$1.rawshape_containsPoint(this.__wbg_ptr, shapePos.__wbg_ptr, shapeRot.__wbg_ptr, point.__wbg_ptr) !== 0;
	}
	/**
	* @param {RawVector} shapePos
	* @param {RawRotation} shapeRot
	...
	*/
	intersectsRay(shapePos, shapeRot, rayOrig, rayDir, maxToi) {
		...
		_assertClass(rayOrig, RawVector);
		_assertClass(rayDir, RawVector);
		return wasm$1.rawshape_intersectsRay(this.__wbg_ptr, shapePos.__wbg_ptr, shapeRot.__wbg_ptr, rayOrig.__wbg_ptr, rayDir.__wbg_ptr, maxToi) !== 0;
	}
	/**
	* @param {RawVector} shapePos
	* @param {RawRotation} shapeRot
	...
	*/
	castRay(shapePos, shapeRot, rayOrig, rayDir, maxToi, solid) {
		...
		_assertClass(rayOrig, RawVector);
		_assertClass(rayDir, RawVector);
		return wasm$1.rawshape_castRay(this.__wbg_ptr, shapePos.__wbg_ptr, shapeRot.__wbg_ptr, rayOrig.__wbg_ptr, rayDir.__wbg_ptr, maxToi, solid);
	}
	/**
	* @param {RawVector} shapePos
	* @param {RawRotation} shapeRot
...
var RawShapeCastHitFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawshapecasthit_free(ptr >>> 0, 1));
var RawShapeCastHit = class RawShapeCastHit {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
...
var RawShapeContactFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm$1.__wbg_rawshapecontact_free(ptr >>> 0, 1));
var RawShapeContact = class RawShapeContact {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
...
var RawVectorFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
...
var RawVector = class RawVector {
	...
	*/
	constructor(x, y) {
		const ret = wasm$1.rawvector_new(x, y);
		this.__wbg_ptr = ret >>> 0;
	...
	*/
	set x(x) {
		wasm$1.rawintegrationparameters_set_dt(this.__wbg_ptr, x);
	}
	/**
	...
	*/
	set y(y) {
		wasm$1.rawvector_set_y(this.__wbg_ptr, y);
	}
	/**
	...
	*/
	xy() {
		const ret = wasm$1.rawvector_xy(this.__wbg_ptr);
		return RawVector.__wrap(ret);
	}
	/**
	...
	*/
	yx() {
		const ret = wasm$1.rawvector_yx(this.__wbg_ptr);
		return RawVector.__wrap(ret);
	}
};
//#endregion
//#region node_modules/@dimforge/rapier2d/rapier_wasm2d.js
__wbg_set_wasm(wasm);
//#endregion
//#region node_modules/@dimforge/rapier2d/math.js
/**
* A 2D vector.
*/
var Vector2 = class {
...
var VectorOps = class VectorOps {
	static new(x, y) {
		return new Vector2(x, y);
	}
	static zeros() {
		return VectorOps.new(0, 0);
	}
	static fromRaw(raw) {
		if (!raw) return null;
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/rigid_body.js
/**
...
var RigidBodyDesc = class RigidBodyDesc {
	constructor(status) {
		this.enabled = true;
		this.status = status;
...
//#endregion
//#region node_modules/@dimforge/rapier2d/coarena.js
var Coarena = class {
	constructor() {
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/rigid_body_set.js
/**
...
var RigidBodySet = class {
	...
	*/
	...
	constructor(raw) {
		...
		if (raw) raw.forEachRigidBodyHandle((handle) => {
	...
	*/
	remove(handle, islands, colliders, impulseJoints, multibodyJoints) {
		for (let i = 0; i < this.raw.rbNumColliders(handle); i += 1) colliders.unmap(this.raw.rbCollider(handle, i));
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/integration_parameters.js
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/impulse_joint.js
/**
...
var ImpulseJoint = class ImpulseJoint {
	...
	static newTyped(rawSet, bodySet, handle) {
		switch (rawSet.jointType(handle)) {
			case RawJointType.Revolute: return new RevoluteImpulseJoint(rawSet, bodySet, handle);
			case RawJointType.Prismatic: return new PrismaticImpulseJoint(rawSet, bodySet, handle);
			case RawJointType.Fixed: return new FixedImpulseJoint(rawSet, bodySet, handle);
			case RawJointType.Spring: return new SpringImpulseJoint(rawSet, bodySet, handle);
			case RawJointType.Rope: return new RopeImpulseJoint(rawSet, bodySet, handle);
			default: return new ImpulseJoint(rawSet, bodySet, handle);
		}
	}
	/** @internal */
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/impulse_joint_set.js
/**
* A set of joints.
*
...
var ImpulseJointSet = class {
	...
	*/
	...
	constructor(raw) {
		...
		this.map = new Coarena();
		if (raw) raw.forEachJointHandle((handle) => {
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/multibody_joint.js
var MultibodyJoint = class MultibodyJoint {
	...
	static newTyped(rawSet, handle) {
		switch (rawSet.jointType(handle)) {
			case RawJointType.Revolute: return new RevoluteMultibodyJoint(rawSet, handle);
			case RawJointType.Prismatic: return new PrismaticMultibodyJoint(rawSet, handle);
			case RawJointType.Fixed: return new FixedMultibodyJoint(rawSet, handle);
			default: return new MultibodyJoint(rawSet, handle);
		}
	}
	/**
	* Checks if this joint is still valid (i.e. that it has
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/multibody_joint_set.js
/**
* A set of joints.
*
* To avoid leaking WASM resources, this MUST be freed manually with `jointSet.free()`
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/coefficient_combine_rule.js
/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/ccd_solver.js
/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/dynamics/island_manager.js
/**
* The CCD solver responsible for resolving Continuous Collision Detection.
*
* To avoid leaking WASM resources, this MUST be freed manually with `ccdSolver.free()`
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/feature.js
var FeatureType;
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/ray.js
/**
...
*/
var RayIntersection = class RayIntersection {
...
*/
var RayColliderIntersection = class RayColliderIntersection {
...
*/
var RayColliderHit = class RayColliderHit {
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/point.js
/**
* The projection of a point on a collider.
*/
var PointProjection = class PointProjection {
...
*/
var PointColliderProjection = class PointColliderProjection {
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/toi.js
/**
* The intersection between a ray and a collider.
*/
var ShapeCastHit = class ShapeCastHit {
...
* The intersection between a ray and a collider.
*/
var ColliderShapeCastHit = class ColliderShapeCastHit extends ShapeCastHit {
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/broad_phase.js
/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/narrow_phase.js
/**
	...
	contactPair(collider1, collider2, f) {
		...
		if (!!rawPair) {
			...
			for (i = 0; i < rawPair.numContactManifolds(); ++i) {
				...
				if (!!this.tempManifold.raw) f(this.tempManifold, flipped);
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/contact.js
/**
* The contact info between two shapes.
*/
var ShapeContact = class ShapeContact {
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/shape.js
var Shape = class {
	/**
	...
	*/
	static fromRaw(rawSet, handle) {
		...
		let normal;
		switch (rawType) {
			case RawShapeType.Ball: return new Ball(rawSet.coRadius(handle));
			...
			case RawShapeType.Voxels: return new Voxels(rawSet.coVoxelData(handle), rawSet.coVoxelSize(handle));
			...
			case RawShapeType.HeightField:
				...
				return new Heightfield(rawSet.coHeightfieldHeights(handle), scale);
			...
			default: throw new Error("unknown shape type: " + rawType);
		}
	}
	/**
...
var Voxels = class extends Shape {
	...
	*/
	...
	intoRaw() {
		...
		let result;
		if (this.data instanceof Int32Array) result = RawShape.voxels(voxelSize, this.data);
		else result = RawShape.voxelsFromPoints(voxelSize, this.data);
		voxelSize.free();
		return result;
	}
};
...
var ConvexPolygon = class extends Shape {
	...
	*/
	...
	intoRaw() {
		if (this.skipConvexHullComputation) return RawShape.convexPolyline(this.vertices);
		else return RawShape.convexHull(this.vertices);
	}
};
/**
* A shape that is a convex polygon.
...
var RoundConvexPolygon = class extends Shape {
	...
	*/
	...
	intoRaw() {
		if (this.skipConvexHullComputation) return RawShape.roundConvexPolyline(this.vertices, this.borderRadius);
		else return RawShape.roundConvexHull(this.vertices, this.borderRadius);
	}
};
/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/pipeline/physics_pipeline.js
var PhysicsPipeline = class {
	...
	step(gravity, integrationParameters, islands, broadPhase, narrowPhase, bodies, colliders, impulseJoints, multibodyJoints, ccdSolver, eventQueue, hooks) {
		...
		if (!!eventQueue) this.raw.stepWithEvents(rawG, integrationParameters.raw, islands.raw, broadPhase.raw, narrowPhase.raw, bodies.raw, colliders.raw, impulseJoints.raw, multibodyJoints.raw, ccdSolver.raw, eventQueue.raw, hooks, !!hooks ? hooks.filterContactPair : null, !!hooks ? hooks.filterIntersectionPair : null);
		else this.raw.step(rawG, integrationParameters.raw, islands.raw, broadPhase.raw, narrowPhase.raw, bodies.raw, colliders.raw, impulseJoints.raw, multibodyJoints.raw, ccdSolver.raw);
		rawG.free();
	}
};
//#endregion
//#region node_modules/@dimforge/rapier2d/pipeline/serialization_pipeline.js
/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/pipeline/debug_render_pipeline.js
/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/control/character_controller.js
/**
...
var KinematicCharacterController = class {
	...
	*/
	computedCollision(i, out) {
		if (!this.raw.computedCollision(i, this.rawCharacterCollision)) return null;
		else {
...
//#endregion
//#region node_modules/@dimforge/rapier2d/control/pid_controller.js
/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/pipeline/world.js
/**
* The physics world.
*
...
var World = class World {
	...
	*/
	static restoreSnapshot(data) {
		return new SerializationPipeline().deserializeAll(data);
	}
	/**
	...
	*/
	removeRigidBody(body) {
		if (this.bodies) this.bodies.remove(body.handle, this.islands, this.colliders, this.impulseJoints, this.multibodyJoints);
	}
	/**
	...
	*/
	removeCollider(collider, wakeUp) {
		if (this.colliders) this.colliders.remove(collider.handle, this.islands, this.bodies, wakeUp);
	}
	/**
	...
	*/
	removeImpulseJoint(joint, wakeUp) {
		if (this.impulseJoints) this.impulseJoints.remove(joint.handle, wakeUp);
	}
	/**
	...
	*/
	removeMultibodyJoint(joint, wakeUp) {
		if (this.impulseJoints) this.multibodyJoints.remove(joint.handle, wakeUp);
	}
	/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/pipeline/event_queue.js
/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/pipeline/physics_hooks.js
var ActiveHooks;
...
//#endregion
//#region node_modules/@dimforge/rapier2d/pipeline/query_pipeline.js
/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/collider.js
/**
...
var Collider = class {
	...
	/** @internal */
	finalizeDeserialization(bodies) {
		if (this.handle != null) this._parent = bodies.get(this.colliderSet.raw.coParent(this.handle));
	}
	ensureShapeIsCached() {
	...
	*/
	contactCollider(collider2, prediction) {
		return ShapeContact.fromRaw(this.colliderSet.raw.coContactCollider(this.handle, collider2.handle, prediction));
	}
	/**
...
var ColliderDesc = class ColliderDesc {
	/**
	...
	*/
	static ball(radius) {
		return new ColliderDesc(new Ball(radius));
	}
	/**
	...
	*/
	static capsule(halfHeight, radius) {
		return new ColliderDesc(new Capsule(halfHeight, radius));
	}
	/**
	* Creates a new segment shape.
	*
	...
	*/
	static segment(a, b) {
		return new ColliderDesc(new Segment(a, b));
	}
	/**
	* Creates a new triangle shape.
	*
	...
	*/
	static triangle(a, b, c) {
		return new ColliderDesc(new Triangle(a, b, c));
	}
	/**
	* Creates a new triangle shape with round corners.
	*
	...
	*/
	static roundTriangle(a, b, c, borderRadius) {
		return new ColliderDesc(new RoundTriangle(a, b, c, borderRadius));
	}
	/**
	...
	*/
	static polyline(vertices, indices) {
		return new ColliderDesc(new Polyline(vertices, indices));
	}
	/**
	...
	*/
	static voxels(voxels, voxelSize) {
		return new ColliderDesc(new Voxels(voxels, voxelSize));
	}
	/**
	...
	*/
	static trimesh(vertices, indices, flags) {
		return new ColliderDesc(new TriMesh(vertices, indices, flags));
	}
	/**
	...
	*/
	static cuboid(hx, hy) {
		return new ColliderDesc(new Cuboid(hx, hy));
	}
	/**
	...
	*/
	static roundCuboid(hx, hy, borderRadius) {
		return new ColliderDesc(new RoundCuboid(hx, hy, borderRadius));
	}
	/**
	...
	*/
	static halfspace(normal) {
		return new ColliderDesc(new HalfSpace(normal));
	}
	/**
	...
	*/
	static heightfield(heights, scale) {
		return new ColliderDesc(new Heightfield(heights, scale));
	}
	/**
	...
	*/
	static convexHull(points) {
		return new ColliderDesc(new ConvexPolygon(points, false));
	}
	/**
	...
	*/
	static convexPolyline(vertices) {
		return new ColliderDesc(new ConvexPolygon(vertices, true));
	}
	/**
	* Computes the convex-hull of the given points and use the resulting
	...
	*/
	static roundConvexHull(points, borderRadius) {
		return new ColliderDesc(new RoundConvexPolygon(points, borderRadius, false));
	}
	/**
	* Creates a new collider descriptor that uses the given set of points assumed
	...
	*/
	static roundConvexPolyline(vertices, borderRadius) {
		return new ColliderDesc(new RoundConvexPolygon(vertices, borderRadius, true));
	}
	/**
...
//#endregion
//#region node_modules/@dimforge/rapier2d/geometry/collider_set.js
/**
* A set of rigid bodies that can be handled by a physics pipeline.
*
...
var ColliderSet = class {
	...
	*/
	...
	constructor(raw) {
		...
		this.map = new Coarena();
		if (raw) raw.forEachColliderHandle((handle) => {
...
//#endregion
//#region node_modules/@dimforge/rapier2d/exports.js
...
//#endregion
//#region node_modules/@dimforge/rapier2d/rapier.js
var rapier_default = exports_exports;
//#endregion
export { ActiveCollisionTypes, ActiveEvents, ActiveHooks, Ball, BroadPhase, CCDSolver, Capsule, CharacterCollision, CoefficientCombineRule, Collider, ColliderDesc, ColliderSet, ColliderShapeCastHit, ConvexPolygon, Cuboid, DebugRenderBuffers, DebugRenderPipeline, EventQueue, FeatureType, FixedImpulseJoint, FixedMultibodyJoint, HalfSpace, Heightfield, ImpulseJoint, ImpulseJointSet, IntegrationParameters, IslandManager, JointAxesMask, JointData, JointType, KinematicCharacterController, MassPropsMode, MotorModel, MultibodyJoint, MultibodyJointSet, NarrowPhase, PhysicsPipeline, PidAxesMask, PidController, PointColliderProjection, PointProjection, Polyline, PrismaticImpulseJoint, PrismaticMultibodyJoint, QueryFilterFlags, Ray, RayColliderHit, RayColliderIntersection, RayIntersection, RevoluteImpulseJoint, RevoluteMultibodyJoint, RigidBody, RigidBodyDesc, RigidBodySet, RigidBodyType, RopeImpulseJoint, RotationOps, RoundConvexPolygon, RoundCuboid, RoundTriangle, Segment, SerializationPipeline, Shape, ShapeCastHit, ShapeContact, ShapeType, SolverFlags, SpringImpulseJoint, TempContactForceEvent, TempContactManifold, TriMesh, TriMeshFlags, Triangle, UnitImpulseJoint, UnitMultibodyJoint, Vector2, VectorOps, Voxels, World, rapier_default as default, reserveMemory, version };
